    ...
    <footer className="border-t bg-muted/30">
      <div className="mx-auto max-w-6xl px-5 md:px-6 py-10">
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            <p className="font-semibold tracking-tight">Saibal Biswas</p>
            ...
            <div className="flex gap-2 mt-4">
              <a href="https://github.com/saibee/saitech" target="_blank" className="h-9 w-9 grid place-items-center rounded-full border bg-background hover:bg-foreground hover:text-background transition"><Code2 size={16} /></a>
              <a href="https://linkedin.com" target="_blank" className="h-9 w-9 grid place-items-center rounded-full border bg-background hover:bg-foreground hover:text-background transition"><ExternalLink size={16} /></a>
              <a href="mailto:hello@saitech.studio" className="h-9 w-9 grid place-items-center rounded-full border bg-background hover:bg-foreground hover:text-background transition"><Mail size={16} /></a>
            </div>
          </div>
          <div>
          ...
          <div>
            ...
            <Link href="/contact" className="inline-flex mt-4 px-4 py-2 rounded-full bg-foreground text-background text-sm font-medium">Let&apos;s talk →</Link>
          </div>
        </div>
